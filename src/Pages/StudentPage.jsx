...
const items1 = [
    { color: "#DA701A", icon: CreditIcon, text: "Fee & Finance", text2: "Configure fees, manage transactions, and track dues.", bgColor: "#FCF9F6", iconBgColor: "#FBF3ED", path: 'fee', disabled: true },

        ...
        <Box sx={{ backgroundColor: "#FFFDF7", width: "100%", }}>
            ...
            >
                ...
                <Box p={3}>
                    {/* {isLoading && <Loader />} */}
                    <Grid container>
                        <Grid item xs={12} sm={12} md={3} lg={3} sx={{ maxHeight: "85vh", overflowX: "auto" }}>
                            <Box>
                                <Typography variant="h6" sx={{ fontWeight: "600" }}>
                                    Detailed Attendance
                                </Typography>
                                                    ...
                                                    <Grid container spacing={1} sx={{ display: "flex" }}>
                                                        {sections.length > 0 ? (
                                                            sections.map((section) => (
                                                                <Grid item xs={4} sm={4} md={4} lg={4} key={section.sectionName}>
                                                                    <ToggleButton
                        ...
                        <Grid item xs={12} sm={12} md={9} lg={9}>
                            ...
                            <Box sx={{ display: "flex" }}>
                                <Grid container>
                                    <Grid item xs={12} sm={12} md={3.3} lg={1.8}>
                                    </Grid>
                                    <Grid item xs={12} sm={12} md={6} lg={4.2} sx={{}} >
                                        <Box sx={{
                                                ...
                                                <Box sx={{ display: "flex", }}>
                                                    ...
                                                    >
                                                        <Box sx={{ padding: 1.3, backgroundColor: '#000', color: '#fff', borderRadius: '8px', width: "110px" }}>
                                                            ...
                                                            >
                                                                <Grid container >
                                                                    <Grid item lg={12} sx={{ display: "flex", justifyContent: "start" }}>
                                                                        <ToggleButton

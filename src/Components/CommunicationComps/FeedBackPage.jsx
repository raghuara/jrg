        ...
        <Box sx={{ width: "100%", }}>
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px",borderBottom:"1px solid #ddd",  }}>
                <Grid container py={1}>
                    ...
                    <Grid item xs={12} sm={12} md={3} lg={3.5} sx={{ display: "flex", justifyContent: "center", alignItems: "center", pt: 1 }}>
                        <Autocomplete
                            disablePortal
                    ...
                    <Grid item xs={12} sm={12} md={3} lg={2.2} sx={{ display: "flex", justifyContent: "end", alignItems: "center", px: 1 }}>
                            ...
                            <Box key={index} sx={{ mb: 4 }}>
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    {dateGroup.parentsFeedBack
                                        ...
                                        .map((newsItem) => (
                                            <Grid item xs={12} sm={12} lg={6} key={newsItem.id}>

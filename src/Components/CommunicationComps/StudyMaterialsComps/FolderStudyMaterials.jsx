import { Box, Grid, Typography, Button, IconButton, CardActionArea, Grid2, Dialog, DialogContent, TextField } from "@mui/material";
        ...
        <Box sx={{ width: "100%" }}>
            ...
            <Box sx={{ p: 2 }}>
                {folders.length === 0 && !isLoading ? (
                    ...
                    <Grid2 container>
                        {folders.map((folder) => (
                            <Grid2 size={{ lg: 2, md: 3, sm: 6 }} sx={{ position: "relative", p: 1 }}>
                                <CardActionArea sx={{
                                    width: "100%",
                                    backgroundColor: "#fff",
                                    borderWidth: "1px",

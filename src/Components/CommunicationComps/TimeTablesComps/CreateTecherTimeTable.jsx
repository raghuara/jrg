...
import { Box, Grid, TextField, Typography, Button, IconButton, Dialog, DialogTitle, DialogContent, DialogActions, Autocomplete, Paper, Table, TableContainer, TableHead, TableRow, TableCell, TableBody, InputAdornment, Grid2, } from "@mui/material";
...
export default function CreateTeacherTimeTablesPage() {
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            <Box sx={{ pt: 10 }}>
                <Grid2 container sx={{ display: "flex", justifyContent: "end", px: 2 }}>
                    <Grid2 size={{ lg: 3, xs: 12, sm: 12, md: 4 }}>
                        <TextField
                            fullWidth
                            variant="outlined"

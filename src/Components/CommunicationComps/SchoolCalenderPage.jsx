        ...
        <Box sx={{ width: "100%" }}>
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px", borderBottom:"1px solid #ddd", }}>
                <Grid container sx={{ py: 1.5 }}>
                    ...
                    <Grid item lg={6} sx={{ display: "flex", justifyContent: "end", alignItems: "center", px: 1 }}>
            ...
            {userType !== "teacher" &&
                <Box sx={{
                    ...
                    >
                        ...
                        <Grid item sm={12} xs={12} lg={6} sx={{ p: 2, borderLeft: "1px solid #EBEBEB" }}>
                            ...
                            <Box sx={{ border: "1px solid #EBEBEB", p: 2, borderRadius: "7px", mt: 2, height: "68vh", overflowY: "auto" }}>
                                ...
                                <Box>
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item sm={12} xs={12} lg={6} sx={{ display: "flex", alignItems: "center" }}>
                                            <Box >
                                                <FormControlLabel
                                                    sx={{ pt: 3.5 }}
                                                    control={

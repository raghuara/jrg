...
export default function ViewMarksPage() {
    ...
    useEffect(() => {
        console.log("Grade from state:", grade);
        console.log("Grade ID from state:", gradeId);
            ...
            <Box>
                ...
                >
                    <Grid container >
                        ...
                        <Grid item xs={12} sm={12} md={4} lg={8} sx={{ mt: 0.5, pl: 3 }}>
                ...
                {/* <Box hidden={value !== 0}> */}
                <Box sx={{ marginTop: "-10px", px: 2, pb: 2 }}>
                    <Box sx={{ display: "flex" }}>

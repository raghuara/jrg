...
export default function CreateExamTimeTablesPage() {
    ...
    const handleInsertMessageData = async (status) => {
        ...
        if (!selectedGrade || !selectedExam || uploadedFiles.length === 0) {
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            <Box sx={{
                ...
                <Typography sx={{ fontWeight: "600", fontSize: "20px" }}>Create Exam Time Tables</Typography>
            </Box>
            <Grid container >
                <Grid item xs={12} sm={12} md={6} lg={6} mt={2} p={2}>
                    <Box sx={{ border: "1px solid #E0E0E0", backgroundColor: "#fbfbfb", py: 2, borderRadius: "7px", mt: 4.5, height: "75.6vh", overflowY: "auto", position: "relative" }}>
                        <Grid container spacing={2} sx={{ px: 2 }}>
                            ...
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <Typography sx={{ mb: 0.5, ml: 1 }}>Select Exam</Typography>
                                <Autocomplete
                                    disablePortal
                                    options={examOptions}

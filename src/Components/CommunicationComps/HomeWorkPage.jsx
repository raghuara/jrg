import { Autocomplete, Box, Button, DialogActions, Dialog, Fab, Grid, IconButton, Paper, Switch, TextField, Typography, ThemeProvider, createTheme, Grid2, styled, ToggleButtonGroup, ToggleButton, Tooltip } from "@mui/material";
...
import { DeleteHomeWork, DeleteTimeTable, GettingGrades, HomeWorkFetch, TimeTableFetch } from "../../Api/Api";
...
export default function HomeWorkPage() {
    ...
    const fetchTimeTables = async () => {
        setIsLoading(true);
        try {
            const res = await axios.get(HomeWorkFetch, {
                params: {

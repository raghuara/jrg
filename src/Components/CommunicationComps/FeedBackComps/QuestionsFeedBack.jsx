        ...
        <Box sx={{ width: "100%", }}>
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px", borderBottom:"1px solid #ddd",  }}>
                <Grid container sx={{ py: 2 }}>
                    <Grid item xs={6} sm={6} md={3} lg={6} sx={{ display: "flex", alignItems: "center" }}>
                    ...
                    <Grid item xs={6} sm={6} md={3} lg={6} sx={{ display: "flex", justifyContent: "end", alignItems: "center", px: 1 }}>

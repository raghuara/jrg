...
import { GetConsentFormById, GetFeedBackDetailByID, GettingGrades, postConsentForm, postMessage, postNews, updateConsentForm, updateFeedBack } from "../../../../Api/Api";
import SnackBar from "../../../SnackBar";
import { selectGrades } from "../../../../Redux/Slices/DropdownController";

export default function FeedBackDraftEditPage() {
    ...
    const handleBackClick = () => {
        if (changesHappended) {
            ...
            navigate('/dashboardmenu/draft/feedback')
        }
    ...
    const handleInsertNewsData = async (status) => {
        ...
        try {
            ...
            const res = await axios.put(updateFeedBack, sendData, {
                headers: {
    ...
    return (
        <Box sx={{ width: "100%" }}>
            ...
            <Box sx={{
                ...
                <Typography sx={{ fontWeight: "600", fontSize: "20px" }}>Edit Feedback</Typography>
            </Box>
            <Grid container >
                                        ...
                                        <FormControl sx={{ width: '100%' }}>
                                            <Select
                                                ...
                                                renderValue={(selected) => {
                                                    ...
                                                    return selected.join(', '); // Display selected section names
                                                }}
                                                MenuProps={{
                                                    PaperProps: {
                                                        sx: {

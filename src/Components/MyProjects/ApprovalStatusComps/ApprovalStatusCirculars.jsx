import { Autocomplete, Box, Button, createTheme, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Fab, Grid2, IconButton, InputAdornment, Paper, styled, Switch, Tab, Tabs, TextField, ThemeProvider, Tooltip, Typography } from "@mui/material";
...
import { ApprovalStatusCircularFetch, ApprovalStatusMessageFetch, ApprovalStatusNewsFetch, DeleteCircular, DeleteNewsApi, NewsFetch } from "../../../Api/Api";
...
export default function ApprovalStatusCircularsPage() {
            ...
            <Box sx={{ backgroundColor: "#f2f2f2", px: 2, borderRadius: "10px 10px 10px 0px",  borderBottom:"1px solid #ddd", }}>
                <Grid2 container>
                    <Grid2 size={{ xs: 12, sm: 12, md: 12, lg: 6.5 }} sx={{ display: "flex", alignItems: "center", py: 1.5 }}>
                        ...
                        <Typography sx={{ fontWeight: "600", fontSize: "20px" }} >Circulars Approval Status</Typography>
                    ...
                    {filteredStatusData.length > 0 ? (
                        <Grid2 container spacing={2}>
                            {filteredStatusData.map((statusItem) => {
                                ...
                                return (
                                    <Grid2 key={statusItem.id} size={{ xs: 12, sm: 12, lg: 12 }}>
                                        <>
                                            ...
                                            >
                                                    ...
                                                    {statusItem.fileType === "empty" &&
                                                        <Grid2 size={{ xs: 12, sm: 12, md: 12, lg: 12 }}>
                                                            ...
                                                            <Box
                                                                ...
                                                                dangerouslySetInnerHTML={{ __html: statusItem.circular }}
                                                            />
                                                            {statusItem.circular.length > 900 && (
                                                                <Button
                                                                    sx={{
                                                                        mt: 1,
                                                                        position: "absolute",
                                                    ...
                                                    {statusItem.fileType !== "empty" && (
                                                        <Grid2 size={{ xs: 12, sm: 12, md: 7, lg: 8.7 }} >
                                                            <Box
                                                                ...
                                                                dangerouslySetInnerHTML={{ __html: statusItem.circular }}
                                                            />
                                                            {statusItem.circular.length > 800 && (
                                                                <Button
                                                                    sx={{
                                                                        mt: 1,
                                                                        position: "absolute",
                                                ...
                                                >
                                                    {
                                                        statusItem.circularStatus === "pending" &&
                                                    ...
                                                    {
                                                        statusItem.circularStatus === "declined" &&
                                                        <>
